...
def play_music():
    ...
    if not paused:
        pygame.mixer.music.load(os.path.directory,current_song)
...
play_button_image = PhotoImage(file= r'C:\Users\vamsh\OneDrive\Desktop\play.png')
pause_button_image = PhotoImage(file= r'C:\Users\vamsh\OneDrive\Desktop\pause.png')
next_button_image = PhotoImage(file= r'C:\Users\vamsh\OneDrive\Desktop\next.png')
previous_button_image = PhotoImage(file= r'C:\Users\vamsh\OneDrive\Desktop\previous.png')
...
pause_button.grid(row=0,column=0,padx=7,pady=10)
next_button.grid(row=0,column=3,padx=7,pady=10)
previous_button.grid(row=0,column=1,padx=7,pady=10)
